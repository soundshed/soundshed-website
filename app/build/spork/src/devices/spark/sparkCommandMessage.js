...
exports.SparkCommandMessage = void 0;
...
class SparkCommandMessage {
    ...
    change_amp_parameter(dspId, paramNumber, val) {
        const cmd = 0x03;
        const sub_cmd = 0x37;
        this.start_message(cmd, sub_cmd);
    ...
    create_preset_from_model(preset) {
        var _a, _b, _c;
        const cmd = 0x01;
        const sub_cmd = 0x01;
        this.start_message(cmd, sub_cmd, true);
        ...
        this.add_string((_a = preset.meta.version) !== null && _a !== void 0 ? _a : "1");
        ...
        this.add_string((_b = preset.meta.icon) !== null && _b !== void 0 ? _b : "icon.png");
        this.add_float((_c = preset.bpm) !== null && _c !== void 0 ? _c : 120);
...
exports.SparkCommandMessage = SparkCommandMessage;
//# sourceMappingURL=sparkCommandMessage.js.map